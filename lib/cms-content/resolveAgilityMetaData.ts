...
export const resolveAgilityMetaData = async ({
  agilityData,
  locale,
  sitemap,
  isDevelopmentMode,
  ...
  if (
    agilityData.sitemapNode.contentID !== undefined &&
    ...
    try {
      ...
      console.warn(
        "Could not resolve open graph meta data from dynamic page contentID:",
        agilityData.sitemapNode.contentID,
        error,
      );
    }
  }
